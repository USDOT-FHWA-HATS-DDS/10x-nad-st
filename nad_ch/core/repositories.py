...
class DataSubmissionRepository(Protocol):
    ...
    def update_mapped_data_path(self, submission_id: int, mapped_data_path: str) -> None: ...
    def update_mapped_data_gdb_path(self, submission_id: int, mapped_data_gdb_path: str) -> None: ...
